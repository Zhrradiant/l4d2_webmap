...
void CreateMixmapVote(int client, MapSetType type)
{
	...
	char		   sInfo[8];
	L4D2VoteHandler fnHandler = CreateMixMapVoteHandler;
	L4D2NativeVote vote = L4D2NativeVote(fnHandler);
...
void CreateStopMixmapVote(int client)
{
	...
	L4D2VoteHandler fnStopHandler = CreateStopMixMapVoteHandler;
	L4D2NativeVote vote = L4D2NativeVote(fnStopHandler);

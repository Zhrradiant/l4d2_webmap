...
void SetupConVars()
{
	...
	// per-campaign limit: 0 = unlimited (use all non-first/last chapters), >= 1 = cap per campaign
	g_hCvar_MaxMapsPerCampaign    = CreateConVar("l4d2mm_max_maps_per_campaign", "0", "Max maps that can be selected from one campaign into the pool. 0 = unlimited.", _, true, 0.0);
}
